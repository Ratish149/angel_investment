...
class Users(models.Model):
    ...
    organization_role = models.CharField(
        max_length=10, choices=ORGANIZATION_ROLE_CHOICES, null=True, blank=True, default='Startup')
...
class CompanyTeam(models.Model):
    ...
    profile_picture = models.FileField(
        upload_to='team_profiles/', null=True, blank=True)
...
class Company(models.Model):
    ...
    stage = models.CharField(
        max_length=100, choices=STAGE_CHOICES, null=True, blank=True)
    ...
    tile_image = models.FileField(
        upload_to='company_tile_images/', null=True, blank=True)
    company_description = models.TextField(null=True, blank=True)
    startup_image = models.FileField(
        upload_to='startup_images/', null=True, blank=True)
